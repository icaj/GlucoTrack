...
from util.util import formato_hora
import json
import pickle
import os
import time
...
def _inserir(medicacao):
    ...
    medicacao_dic = {'codigo': proximo_codigo + 1, 
                     ...
                     'hora_inicial': time.strftime(formato_hora, medicacao.hora_inicial), 
...
def _atualizar(medicacao):
    ...
    for r in medicacoes:
        if r['codigo'] == medicacao.codigo:
            ...
            r['hora_inicial'] = time.strptime(formato_hora, medicacao.hora_inicial)
